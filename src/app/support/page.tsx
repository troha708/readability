...
export const metadata: Metadata = {
  title: "Support",
  description:
    "Three ways to help Readability: share it with someone, donate, or contribute code when the project opens its source.",
};
      ...
      <article className="mx-auto w-full max-w-2xl flex-1 px-6 pb-24 pt-6">
        ...
        <div className="mt-8 space-y-8 font-scripture text-[16px] font-normal leading-relaxed text-neutral-800 dark:text-white">
          ...
          <section>
            ...
            <p className="mt-2">
              The plan is to open the whole project as open source: the app,
              the fact corpus, and the Bible atlas. If you are a developer and
              want to contribute, the GitHub repository is coming soon. Email{" "}
              <a
